...
[NOTE]
====
The SYCL definition of inclusive scope follows the OpenCL definition.
In OpenCL versions prior to 3.1, the memory scopes of A and B must be the same
for their scopes to be inclusive, but this was relaxed in OpenCL version 3.1.
